...
public class GitHubSourceConnectorConfig extends AbstractConfig {
    ...
    public static final String NODE_TYPE_CONFIG = "node.type";
    private static final String NODE_TYPE_DOC = "Node type information";
    ...
    public String getNodeConfig() {
    	return this.getString(NODE_TYPE_CONFIG);
    }
